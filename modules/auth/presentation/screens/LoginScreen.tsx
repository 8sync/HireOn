  ...
  return (
    <div className={styles.authLayout}>
      <div className={styles.leftPanel}>
        ...
        <div className={styles.slideContainer} style={{ paddingBottom: '50px' }}>
          <div
      ...
      <div className={styles.rightPanel}>
        <div className={styles.authCard}>
          <div className={styles.authHeader}>
            <h2 className={styles.brandTitle}>Sign in to your account</h2>
          ...
          <form className={styles.form}>
            ...
            <div className={styles.formOptions} style={{ marginTop: '20px' }}>
          ...
          <div className={styles.signupPrompt}>
            Don&apos;t have an account? <Link href={AppRoutes.auth.register} className={styles.signupLink}>Sign Up</Link>
          </div>
        </div>
      </div>
    </div>
